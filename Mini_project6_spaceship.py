...
#missile_sound = simplegui.load_sound("http://www.sa-matra.net/sounds/starwars/ATST-ChinGuns.wav")
#missile_sound = simplegui.load_sound("http://commondatastorage.googleapis.com/codeskulptor-assets/sounddogs/missile.mp3")
#missile_sound = simplegui.load_sound("http://www.sa-matra.net/sounds/starwars/Naboo-Torp.wav")
